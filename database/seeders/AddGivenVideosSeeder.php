...
class AddGivenVideosSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $videos = [
            ...
            [
                'course_id' => $tddCourse->id,
                'slug' => 'intro',
                'vimeo_id' => '444444444',
                'title' => 'Intro',
                'description' => 'Welcome to TDD The Laravel Way. Overview and goals for the course.',
                'duration_in_min' => 3,
            ],
            [
                'course_id' => $tddCourse->id,
                ...
                'vimeo_id' => '555555555',
                'title' => 'Writing Tests',
                'description' => 'Hands-on: writing your first tests with PHPUnit/Pest and designing for testability.',
                'duration_in_min' => 10,
            ],
        ];
        ...
        foreach ($videos as $video) {
            Video::updateOrCreate(
                ['course_id' => $video['course_id'], 'slug' => $video['slug']],
                [
                    'vimeo_id' => $video['vimeo_id'],
                    'title' => $video['title'],
                    'description' => $video['description'],
                    'duration_in_min' => $video['duration_in_min'],
                ]
            );
        }
    }
